...
# ---------------- проверка совпадения стоимости по проекту----------------------------------------------------
    ...
    if cost_for_verification == project_cost_act:
        ...
        text7 = '   Стоимость проекта - Неверно (проверьте, пожалуйста, расчет стоимости проекта. Согласно данным акта стоимость должна быть равна ' + cost_for_verification + ' р.) \n\n'
